...
# plot comp site SAC
plot(CompRichness, ci.type = "poly", lwd = 2, ci.lty = 0, ci.col = rgb(0,0,0,0.3), 
        main = "", xlab = "# of plots sampled", ylab = "# of native species", ylim = c(0,40))

# plot reference site SAC
lines(Ref1Richness, ci.type = "poly", ci.col = rgb(0,0,0,0.1), lwd = 2, ci.lty = 0, lty = 2)
lines(Ref2Richness, ci.type = "poly", ci.col = rgb(0,0,0,0.1), lwd = 2, ci.lty = 0, lty = 4)
