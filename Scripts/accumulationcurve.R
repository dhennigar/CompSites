...
# Compensation Site
Comp <- read.csv("./FieldData/2021/14-001.csv", fileEncoding = "UTF-8-BOM")
...
Ref1 <- read.csv("./FieldData/2015/csv/REF-03.csv", fileEncoding = "UTF-8-BOM")
...
Ref2 <- read.csv("./FieldData/2021/REF-04.csv", fileEncoding = "UTF-8-BOM")
...
# legend
legend(1, 38, legend = c("14-001", "REF-03", "REF-04"),
